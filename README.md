...
1.  **Create a Resource Group:**
    * Logged into the Azure portal and created a new Resource Group called **rg-main** to organize the VMs.
...
2.  **Create a Windows 10 Virtual Machine (VM):**
    ...
    * Created a Windows 10 VM in Azure.
        * Selected the previously created Resource Group, **rg-main**.
...
2.  **Install Wireshark (Windows 10 VM):**
